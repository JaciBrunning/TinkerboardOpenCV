...
# curl -SL https://github.com/JacisNonsense/TinkerboardGCC/releases/download/20181227.8/Tinkerboard-Linux-Toolchain-6.3.0.tar.gz | sh -c 'mkdir -p /usr/local && cd /usr/local && sudo tar xzf - --strip-components=1'
